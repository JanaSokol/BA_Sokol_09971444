...
public class Endpoint {
    ...
    @Autowired
    public Endpoint(GfsService gfsService, IconService iconService, IconImageMapper iconImageMapper, GfsImageMapper gfsImageMapper) {
     ...
     *
     * @param date    to find gfs by.
     * @param visType visualization type.
     * @return a list of GfsImageDto
     */
    @GetMapping(path = "/gfs")
     ...
     *
     * @param date    to find icon by.
     * @param visType visualization type.
     * @return a list of IconImageDto
     */
